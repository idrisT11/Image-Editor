...
public:
    ...
    static Mat erosion(Mat& img, int kernel_type=ImageTransformer::MATHMORPH_ELLIPSE);
    static Mat dilatation(Mat& img, int kernel_type=ImageTransformer::MATHMORPH_ELLIPSE);
